...
function Card() {
  ...
  return (
    ...
    <div className="min-h-screen lg:p-30 md:p-20 sm:p-10">
      {/* Grid of Cards */}
      <div className="grid grid-cols-2  sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5  gap-4 mb-8">
        {visibleCards.map((imgUrl, index) => (
          <div key={index} className="p-4 ">
            <img  src={imgUrl} alt={`Card ${startIndex + index + 1}`} className="gallaryImg  shadow-lg overflow-hidden w-[25vw] mx-8  sm:w-[25vw] md:w-[20vw] lg:w-[16vw]  gap-12 h-[14vw] mt-[1vw] cursor-pointer" />
