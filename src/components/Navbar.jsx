            ...
            <div className="block justify-center flex sm:flex ">
                ...
                <div className="flex flex-col sm:block hidden gredient  w-3/4">
                    <div className="flex justify-between  gredient-nav p-8 items-center  ">
                        ...
                        <div><img className="xl:w-58 lg:w-50 md:w-45 sm:w-30" src="https://res.cloudinary.com/dapozvnbr/image/upload/v1600086643/Logo_hafewu.png" alt="img" /></div>

                        <nav>
                            <ul className="flex gap-10 md:gap-5 lg:text-[20px] md:text-[16px] sm:gap-2 sm:text-[12px] raleway font-bold text-lg ">
                    ...
                    <div className="">
                        <div className="xl:text-8xl lg:text-7xl md:text-6xl sm:text-4xl raleway text-stone-800 font-bold lg:mt-35  md:mt-20 sm:mt-20 md:p-10 sm:p-5  p-25" >
                ...
                <div className="sm:hidden block raleway gredient pt-[6vw]">
                ...
                <div className="flex flex-col w-1/2 gradient  ">
                    <div className="sm:block hidden">
                        <div className="flex  justify-center gap-18  items-center bg-stone-900 p-7 ">
                            ...
                            <button class="btn-nav text-[11px] md:text-[1.5vw] lg:text-sm hover:bg-blue-600bg text-white font-semibold py-2 px-4 rounded-lg shadow">
                                GET STARTED
                            </button>
                        </div>
                    </div>
